...
def icomma_render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, compute_grad_cov2d=True):
    """
    Render the scene. 
    ...
    raster_settings = iCommaGaussianRasterizationSettings(
        image_height=int(viewpoint_camera.image_height),
        image_width=int(viewpoint_camera.image_width),
        tanfovx=tanfovx,
        tanfovy=tanfovy,
    ...
    rasterizer = iCommaGaussianRasterizer(raster_settings=raster_settings)
...
def renderer(camera, pc : GaussianModel, pipe, scaling_modifier = 1.0, override_color = None):
    """
    Render the scene. 
